...
const RecommendationsModal = ({ isOpen, closeModal }) => {
  ...
  return (
    ...
    >
      <div className="bg-white p-8 w-full max-w-4xl max-h-svh overflow-y-auto rounded-md relative">
        <h2 className="text-2xl lg:w-96 font-bold mb-4 ">Decission supporting Recommendations</h2>
        ...
        <ul>
          {pastRequisitions.map((req, index) => (
            <li key={index} className="mb-4 border-b-2 scroll-m-1 border-gray-300">
              <strong>Recommendation:</strong> {splitDateTime(req.date).date}<br />
