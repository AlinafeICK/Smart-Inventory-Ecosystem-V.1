...
import MakeRequisitionModal from '../modals/ApproveDisapproveModal ';
      ...
      <div className="container bg-gray-100 border-t-2 border-blue-500 p-4">
        ...
        >
          ...
          {console.log('Selected Action:', selectedAction)}
            {selectedAction && (
              <>
                {selectedAction.title === 'Approve/disapprove request' && <MakeRequisitionModal isOpen={!!selectedAction} closeModal={closeModal} />}
                {selectedAction.title === 'Recommendations' && <RecommendationsModal isOpen={!!selectedAction} closeModal={closeModal} />}
